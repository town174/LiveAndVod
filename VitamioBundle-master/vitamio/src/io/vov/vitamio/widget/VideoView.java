 ...
 */
@SuppressLint("NewApi") public class VideoView extends SurfaceView implements MediaController.MediaPlayerControl {
  ...
  public void start() {
    if (isInPlaybackState()) {
      ...
      //Toast.makeText(getContext(), "start method is working!", Toast.LENGTH_LONG).show();
      //android.util.Log.i("view", "start method is working!");
    }
    mTargetState = STATE_PLAYING;
  }
  ...
  public void pause() {
    if (isInPlaybackState()) {
      if (mMediaPlayer.isPlaying()) {
        ...
        //Toast.makeText(getContext(), "pause method is working!", Toast.LENGTH_LONG).show();
        //android.util.Log.i("view", "pause method is working!");
      }
    }
